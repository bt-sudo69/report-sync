      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed mb-4"
